...
sensor_pin1 = 'P9_40' #mid heater
sensor_pin2 = 'P9_37' #mid pump
sensor_pin3 = 'P9_38' #low uv
sensor_pin4 = 'P9_33' #low charger
#sensor_pin5 = 'P9_36'
#sensor_pin6 = 'P9_35'
...
filename = "{0}_{1}_{2}_conex-power.csv".format(currentyear, currentmonth, currentday)
...
while True:
        ...
        AMPS2=volts2/0.25 #Volts / (V/A) = amps
       ...
       # print pt,'\t%s\t%f\t%f\t%f\t%i' % ( "6",reading6,volts6,AMPS6,count)
        ...
        if (now.tm_sec == 0)&(count>10): #if new minute, write data to file
                ...
                file.write(",%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f\n" % (AVE_AMPS1,AVE_WATTS1,TOT_KWH1,AVE_AMPS2,AVE_WATTS2,TOT_KWH2,AVE_AMPS3,AVE_WATTS3,TOT_KWH3,AVE_AMPS4,AVE_WATTS4,TOT_KWH4))
        ...
        if (os.path.isfile(filename) and restart):
            ...
            file.write("time,amps1,watts1,totkw1,amps2,watts2,totkw2,amps3,watts3,totkw3,amps4,watts4,totkw4\n")
            file.write(pt)
            file.write(",%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f\n" % (AVE_AMPS1,AVE_WATTS1,TOT_KWH1,AVE_AMPS2,AVE_WATTS2,TOT_KWH2,AVE_AMPS3,AVE_WATTS3,TOT_KWH3,AVE_AMPS4,AVE_WATTS4,TOT_KWH4))
            file.close()
